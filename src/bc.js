...
class App extends Component {
    ...
    render() {
        ...
        const loginPage = <div className="ui grid container center aligned">
            <div className="row">
        ...
        const menubar = <div class="ui container">
                ...
                <div className="ui container">
                    <nav className="navbar navbar-expand-sm bg-dark navbar-dark">
                        <ul className="navbar-nav">
                            ...
                            <li className="nav-item">
                                <a className="nav-link" href="/Landline">
                                    Landline
                  </a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link" href="/Cellular">
                                    Cellular
                  </a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link" href="/Broadband">
                                    Broadband
                  </a>
                            </li>
                            <li className="nav-item">
                            ...
                            <div className="right alignment" id="user_name" style={styles.user_name}>
        ...
        return <div>{this.state.isSignedIn ? menubar : loginPage}</div>;
    }
}
