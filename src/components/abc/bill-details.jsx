    ...
    render() {
        ...
        return (
            this.state.billdetails ?
                <div>
                    <div className="card">
                        <h3 className="card-header text-black">Product Detail: <span className="fa fa-phone pull-right">
                        ...
                        <div className="row" >
                        <button className="btn btn-primary text-white  col-11 ml-4 mb-2 col-md-3 offset-md-12"> <Link  to={`/`} style={styles.btncolor} > Back </Link> </button>
                        <button className="btn btn-primary text-white col-11  ml-4 mb-2 col-md-3"> <Link  to={`/previous_bill/${this.state.billdetails.id}`} style={styles.btncolor}> Bill History</Link></button>
                        <button className="btn btn-primary text-white mb-2 col-11 ml-4 col-md-3" onClick={this.handlePdf}>Download PDF</button>
